/*
  Lock down CMS/admin data access after earlier migrations granted anon users
  broad CRUD access for the browser-based admin panel.

  Public visitors may read public marketing content and submit contact/lead
  forms. Private data reads, CMS mutations, and storage writes require the
  Commergio admin Supabase user.
*/

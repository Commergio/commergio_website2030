/*
  # Lock down CMS/admin policies after anonymous admin bypass

  Previous CMS policies allowed the browser anon key to read private admin data
  and mutate CMS/storage rows. This migration preserves public marketing reads
  and public form inserts, but requires the Commergio admin account for private
  reads and all admin mutations.
*/

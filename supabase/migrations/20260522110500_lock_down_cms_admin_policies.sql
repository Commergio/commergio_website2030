/*
  Lock down CMS/admin policies that previously allowed anonymous mutations.

  Public visitors can still read public site content and submit forms. Reads of
  private records, CMS writes, and storage object writes are limited to the

/*
  Lock down CMS/admin policies that were previously writable with the public anon key.
  Public visitors can still read site content and submit forms; admin/private data and
  mutations require the authenticated Commergio admin account.
*/

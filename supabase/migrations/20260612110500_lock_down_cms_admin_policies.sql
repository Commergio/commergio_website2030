/*
  Lock down CMS/admin RLS policies that previously allowed anonymous CRUD.

  Public visitors may read public site content and submit public forms. Private
  data reads, CMS mutations, and storage writes require the Commergio admin user.
*/

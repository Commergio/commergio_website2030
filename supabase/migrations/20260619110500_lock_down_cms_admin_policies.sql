/*
  Lock down CMS/admin RLS policies that were previously opened to the anon key.

  Anonymous users may submit public forms and read public CMS content. Private
  submissions/invoices and every CMS/storage mutation require the authenticated
  Commergio admin account.
*/

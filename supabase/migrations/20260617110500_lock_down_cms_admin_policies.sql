/*
  Lock down CMS/admin policies that were previously opened to the browser anon key.

  Public users may read published/public content and submit contact/project forms.
  Private data, unpublished CMS rows, storage listings for signing videos, and all
  CMS/storage mutations require the Commergio admin Supabase user.
*/

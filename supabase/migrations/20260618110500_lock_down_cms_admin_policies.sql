/*
  Lock down CMS/admin policies that were previously opened to the anon key.

  Public visitors can read public marketing content and submit contact/project
  forms. Private data reads and every CMS/storage mutation require the

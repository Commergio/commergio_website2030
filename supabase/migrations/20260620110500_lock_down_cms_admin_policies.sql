/*
  Lock down CMS/admin RLS policies that previously allowed public anon writes.

  Public visitors can still read published site content and submit contact/lead
  forms. Private admin data and all CMS/storage mutations require the
  info@commergio.com Supabase session.
*/
